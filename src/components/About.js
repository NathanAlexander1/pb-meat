...
function About() {
  return (
    ...
    <hr />
      ...
      <br />
      <p>
        Fleshtables is the world's first human-flavored plant-based meat!
        Finally, anybody can try "human" flesh without the pending guilt of
        being labeled a societal outcast. No need to fear pesky police arresting
        you for cannabalism...fleshtables provides all the texture and flavor of
        human flesh without the risk of lifelong imprisonment...it's a win-win!
      </p>

      <br />
      <p>Well, what are you waiting for?...try it today!</p>
    </div>
  );
}
